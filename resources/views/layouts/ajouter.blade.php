...
<body style="  background-image: url('./img/ajoutback.jpg');">
    
        
        <div>
          <!-- general form elements -->
          <div style="width:600px; margin-left:380px; margin-top:50px; margin-bottom:50px;" class="card card-primary form">
